...
export default function App() {
  ...
  useEffect(() => {
    ...
    ws.onmessage = (event) => {
      ...
      for (let i = 0; i < 4; i++) {
          const frontEl = document.getElementById(`zone-${idx => i}-front`);
          const rearEl = document.getElementById(`zone-${idx => i}-rear`);
  ...
  return (
    <div style={{ position: 'relative', width: '100vw', height: '100vh', background: 'radial-gradient(circle at center, #0a0e17 0%, #020203 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
      ...
      {/* Color Classification Legend Box */}
      <div style={{
        position: 'absolute',
        bottom: '30px',
        left: '30px',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <span style={{ width: '18px', height: '18px', backgroundColor: '#FF0000', display: 'inline-block', flexShrink: 0 }} />
            <span style={{ color: '#ffffff', fontSize: '13px', fontWeight: '500', letterSpacing: '0.2px' }}>Car / Truck / Bike</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <span style={{ width: '18px', height: '18px', backgroundColor: '#0080FF', display: 'inline-block', flexShrink: 0 }} />
            <span style={{ color: '#ffffff', fontSize: '13px', fontWeight: '500', letterSpacing: '0.2px' }}>Pedestrian + Bicycle</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <span style={{ width: '18px', height: '18px', backgroundColor: '#138808', display: 'inline-block', flexShrink: 0 }} />
            <span style={{ color: '#ffffff', fontSize: '13px', fontWeight: '500', letterSpacing: '0.2px' }}>Vegetation</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <span style={{ width: '18px', height: '18px', backgroundColor: '#FFDD00', display: 'inline-block', flexShrink: 0 }} />
            <span style={{ color: '#ffffff', fontSize: '13px', fontWeight: '500', letterSpacing: '0.2px' }}>Building</span>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <span style={{ width: '18px', height: '18px', backgroundColor: '#9ea8b6', display: 'inline-block', flexShrink: 0 }} />
            <span style={{ color: '#ffffff', fontSize: '13px', fontWeight: '500', letterSpacing: '0.2px' }}>Road</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <span style={{ width: '18px', height: '18px', backgroundColor: '#00bfff', display: 'inline-block', flexShrink: 0 }} />
            <span style={{ color: '#ffffff', fontSize: '13px', fontWeight: '500', letterSpacing: '0.2px' }}>Pothole Candidate</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <span style={{ width: '18px', height: '18px', backgroundColor: '#9b26ff', display: 'inline-block', flexShrink: 0 }} />
            <span style={{ color: '#ffffff', fontSize: '13px', fontWeight: '500', letterSpacing: '0.2px' }}>Crub</span>
          </div>
        </div>
      </div>
